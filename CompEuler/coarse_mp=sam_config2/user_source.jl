...
function user_source!(S, q, qe, npoin, ::CL,::PERT; neqs=1,x=0.0, y=0.0, ymin=0.0, ymax=24000.0, ngl=5, nely=10,xmin = -75000, xmax =75000, ctop_mult=0.01)  # CHANGED: ymax and xmin/xmax
