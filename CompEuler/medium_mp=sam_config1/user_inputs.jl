function user_inputs()
    inputs = Dict(
        ...
        :tinit                => 0.0,
        :tend                 => 86400.0,
        :diagnostics_at_times => 0.0:600.0:86400.0, #
        #:tinit                => 100.0,
        #:tend                 => 1000.0,
        #:lrestart             => true,
       ...
       # :diagnostics_at_times => (0.0, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 9000, 12000, 15000, 20000, 25000, 28800),
        ...
        :ivisc_equations => [2, 3, 4],  # Momentum diffusion
        :μ => [0.0, 50.0, 50.0, 50.0, 0.0, 0.0],
        #---------------------------------------------------------------------------
        ...
        :gmsh_filename       => "./meshes/gmsh_grids/medium_4.msh",
        ...
        #---------------------------------------------------------------------------
        :outformat           => "vtk", #"hdf5",
        :output_dir          => "./medium_mp=sam_config1a/",
